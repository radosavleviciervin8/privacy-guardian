...
- Hashes prove a record has not changed since creation; they do not prove *when* it was created to a third party. For stronger provenance, hash the exported JSON with an independent timestamping service.
